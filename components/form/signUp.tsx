...
const FormSignUp = ({ onSubmit }: FormSignUpProps) => {
  ...
  return (
    ...
    //     <h2 className={styles["signup__caption"]}>Sign up with</h2>
    //     <div className={styles["signup-social"]}>
    //       <div className={styles["signup-social__item"]} onClick={() => signIn("google")}>
    //         <Image
    //           src="/icons/google.svg"
    //           width={20}
    //           height={20}
    ...
    //         <span className={styles["signup-social__text"]}>Login with Google</span>
    //       </div>
    //       <div
    //         className={styles["signup-social__item"]}
    //         onClick={() => signIn("facebook")}
    ...
    //         <span className={styles["signup-social__text"]}>Login with FaceBook </span>
    //       </div>
    //     </div>
    //     <form className={styles["signup-form"]} method="post" onSubmit={handelFormSubmit}>
    //       <div className={styles["signup-form__row"]}>
    //         <div className={styles["signup-form__group"]}>
    //           <label htmlFor="name" className={styles["signup-form__label"]}>
    //             Name
    ...
    //         </div>
    //         <div className={styles["signup-form__group"]}>
    //           <label htmlFor="passwordConfirm" className={styles["signup-form__label"]}>
    //             Password Confirm
    //           </label>
    //           <input
    //             type="password"
    ...
    //       <button className={styles["signup-form__submit" type="submit" name="register"]}>
    //         <Image
    //           src="/icons/login.svg"
    //           alt="Login"
    //           width={30}
